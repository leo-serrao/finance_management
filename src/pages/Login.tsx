  ...
  async function handleGoogle() {
    ...
    try {
      ...
      if (err?.code === 'auth/operation-not-allowed') {
        setError(
          'Login com Google está desabilitado no Firebase.'
        )
      } else {
    ...
    <div className="relative w-full max-w-md">
      ...
      <div className="mb-12 flex flex-col items-center text-center">
        ...
        <p
          ...
          "
        >
          Clareza financeira para sua vida pessoal
          e compartilhada.
        </p>
      ...
      >
        ...
        <div
          className="
            ...
            h-px bg-white/70 dark:bg-white/10
          "
        />
